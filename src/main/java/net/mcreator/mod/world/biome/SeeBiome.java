...
public class SeeBiome extends ModModElements.ModElement {
	public static Biome biome;
	public SeeBiome(ModModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-5994824).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(10387789).withGrassColor(9470285).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BooBlock.block.getDefaultState(),
								BooBlock.block.getDefaultState(), BooBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("mod:see"));
			}
		}
	}
	@Override
